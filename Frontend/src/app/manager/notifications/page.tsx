                ...
                <div className="p-4 border-b border-slate-200 bg-slate-50/50">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm font-medium bg-white shadow-sm"
                        />
                    </div>
                </div>
                ...
                {isLoading ? (
                    ...
                    <div className="divide-y divide-slate-100">
                        {filteredNotifications.map((notif) => (
                            <div
                                key={notif.id}
                                className={`p-6 transition-all duration-300 flex gap-4 ${notif.isRead ? 'bg-white hover:bg-slate-50' : 'bg-blue-50/50 hover:bg-blue-50/80 border-l-4 border-blue-500'}`}
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    {!notif.isRead && (
                                        <button
                                            ...
                                            className="text-xs font-bold text-blue-600 hover:text-blue-800 transition-colors flex items-center gap-1.5 bg-blue-50 px-3 py-1.5 rounded-lg border border-blue-200/50 hover:bg-blue-100"
                                        >
